...
from mcp.config.settings import get_settings
from mcp.config.logging_config import setup_logging
from mcp.adapters.factory import build_sensor_provider, build_rera_provider
from mcp.routes import project_routes, rera_routes, sensor_routes
from mcp.services.sensor_service import SensorService
from mcp.services.rera_service import RERAService
from mcp.services.project_service import ProjectService
from mcp.services.status_service import StatusService
from mcp.middleware.logging_middleware import LoggingMiddleware
from mcp.utils.exceptions import register_exception_handlers

from mcp.routes import status_routes
